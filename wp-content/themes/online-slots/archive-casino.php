    ...
    <section class="section-two casino">
        <div class="container">
            ...
            <div class="section-top two">
                ...
                <button class="section-more btn-six"><?php echo __('Read more...', 'slots'); ?></button>
            </div>
            ...
            <button class="casino-load btn-two"><?php echo __('Load more', 'slots'); ?></button>
        </div>
    </section>
                            ...
                            <div class="container">
                                ...
                                <ul class="what-list">
                                    <li class="what-list_point title-l">
                                        <h3 class="what-list_title title-l"><span>+</span> <?php echo __('Pluses', 'slots'); ?>:</h3>
                                    ...
                                    <li class="what-list_point">
                                        <h3 class="what-list_title title-l"><span>-</span> <?php echo __('Minuses', 'slots'); ?>:</h3>
                                        <div class="what-list_content content">
                                            <ul>
