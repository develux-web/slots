                ...
                <div class="filter-wrap">
                    <div class="form-search filter-search">
                        <label class="form-search_label">
                            <input id="search-input" class="form-search_point" type="search" name="search" placeholder="Search slots..." data-type="slots">
                    ...
                    <?php
                        echo display_taxonomy_select('features');
                        echo display_taxonomy_select('themes');
                    ?>
                </div>
...
<div class="section-wrap">
    <div class="section-box">
        <?php if( have_rows('content_fields_slots', 'option') ): ?>
            <?php while( have_rows('content_fields_slots', 'option') ): the_row(); ?>
