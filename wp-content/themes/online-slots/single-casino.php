...
$postID = $post->ID;
$lang = get_the_terms( $postID, 'languages' );
$pokies = get_the_terms( $postID, 'free-pokies' );
$providers = get_the_terms( $postID, 'providers' );
$payment = get_the_terms( $postID, 'payment-methods' );
?>
...
<section class="section-two casino">
    <div class="container">
            ...
            <div class="casino-contain">
                <div class="casino-box">
                    <div class="casino-time">
                        <span class="casino-time_label"><?php echo __('Time left', 'slots'); ?></span>
                    ...
                    <ul class="casino-price">
                        <li>
                            <span class="casino-label"><?php echo __('Min deposit', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['min_deposit']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Max deposit', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['max_deposit']; ?>
                            </span>
                        </li>
                    </ul>
                    <?php foreach ($casinoInfo['best_game'] as $value){ ?>
                    <div class="casino-best">
                        <span class="casino-label"><?php echo __('Best game', 'slots'); ?></span>
                        <span class="casino-name">
                            <?php echo $casinoInfo['best_game']['best_game_title']; ?>
                        </span>
                        <a href="<?php echo $casinoInfo['best_game']['best_game_link']; ?>" class="casino-play btn-two">
                            <?php echo __('Play', 'slots'); ?>
                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="casino-web">
                        <span class="casino-label"><?php echo __('Website', 'slots'); ?></span>
                        <a href="<?php echo $casinoInfo['website']; ?>" class="casino-link">
                            <?php echo $casinoInfo['website_title']; ?>
                        </a>
                    </div>
                    <div class="casino-lang">
                        <span class="casino-label"><?php echo __('Languages', 'slots'); ?></span>
                ...
                <div class="casino-content">
                    ...
                    <ul class="casino-tabs">
                        <li>
                            <span class="casino-label"><?php echo __('Author:', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['author']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Updated:', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['updated']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Number of games:', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['number_of_games']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Licences', 'slots'); ?></span>
                            <span class="casino-name">
                    ...
                    <div class="casino-free">
                        <span class="casino-sub"><?php echo __('Free Pokies', 'slots'); ?></span>
                    ...
                    <div class="casino-providers">
                        <span class="casino-sub"><?php echo __('Providers', 'slots'); ?></span>
                    ...
                    <div class="casino-payment">
                        <span class="casino-sub"><?php echo __('Payment methods', 'slots'); ?></span>
                    ...
                    <ul class="casino-data">
                        <li>
                            <span class="casino-label"><?php echo __('Established', 'slots'); ?></span>
                            <span class="casino-name">
                                <?php echo $casinoInfo['established']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Owner', 'slots'); ?></span>
                            <span class="casino-name">
                                  <?php echo $casinoInfo['owner']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Support', 'slots'); ?></span>
                            <span class="casino-name">
                                  <?php echo $casinoInfo['support']; ?>
                            </span>
                        </li>
                        <li>
                            <span class="casino-label"><?php echo __('Currencies', 'slots'); ?></span>
                            <span class="casino-name">
        ...
        <button class="casino-more btn-two">
            <span><?php echo __('More info', 'slots'); ?></span>
            <span><?php echo __('Hide info', 'slots'); ?></span>
        </button>
    </div>
</section>
<!--/casino-->
...
<div class="section-wrap">
    <div class="section-box">
        ...
        <?php } elseif( get_row_layout() == 'casino_list' ){
            ...
            <!--work-->
            <section class="section-one <?php echo $gameList['section_id']; ?>" id="<?php echo $gameList['section_id']; ?>">
                <div class="container">
                    <div class="section-top">
                        <h2 class="section-title title-x">
        ...
        <?php } elseif( get_row_layout() == 'casino_faq' ){
            ...
            <!--faq-->
            <section class="section-one <?php echo $gameFAQ['section_id']; ?>" id="<?php echo $gameFAQ['section_id']; ?>">
                <div class="container">
                    <div class="section-top">
                        <h2 class="section-title title-x">
