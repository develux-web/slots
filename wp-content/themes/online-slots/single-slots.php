...
<section class="section-two game">
    <div class="container">
        <ul class="breadcrumbs">
            ...
            <li>
                <span>Fishin Frenzy</span>
            </li>
        </ul>
        <div class="section-top five">
            <h1 class="section-title title-xl">Fishin Frenzy - NZ Review, Demo Play, Payout, Free Spins & Bonuses</h1>
        </div>
        <div class="game-wrap">
            <div class="game-info">
                <div class="game-info_top">
                    <div class="game-rating">
                        <span class="game-rating_number">3</span>
                        <span class="game-rating_stars" data-stars="3"></span>
                    </div>
                ...
                <div class="game-info_wrap">
                    <img class="game-img" src="img/game-1.jpg" alt="img">
                    <div class="game-content">
                        ...
                        <a href="#" class="game-play btn-four">
                            Play for real
                            <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="game-box">
                <span class="game-label">Slot Data</span>
                <div class="game-point">
                    <span class="game-sub">Software:</span>
                    <ul class="game-links">
                        <li><a href="#">Blueprint Gaming</a></li>
                        <li><a href="#">Reel Time Gaming</a></li>
                    </ul>
                </div>
                <div class="game-point">
                    <span class="game-sub">Volatility:</span>
                    <ul class="game-links">
                ...
                <div class="game-point">
                    <ul class="game-list">
                        <li>
                            <span class="game-sub">RTP:</span>
                            <span class="game-number">96.12%</span>
                        </li>
                        <li>
                            <span class="game-sub">Paylines:</span>
                            <span class="game-number">10</span>
                        </li>
                        <li>
                            <span class="game-sub">Reels:</span>
                            <span class="game-number">5</span>
                        </li>
                        <li>
                            <span class="game-sub">Top Win:</span>
                            <span class="game-number">5000</span>
                        </li>
                        <li>
                            <span class="game-sub">Min Bet:</span>
                            <span class="game-number">$0.20</span>
                        </li>
                        <li>
                            <span class="game-sub">Max Bet:</span>
                            <span class="game-number">$400</span>
                        </li>
                    </ul>
                </div>
                <div class="game-point">
                    <span class="game-sub">Features:</span>
                    <ul class="game-tabs">
                        <li><a href="#">Bonus Game</a></li>
                        <li><a href="#">Wild Symbol</a></li>
                        <li><a href="#">Free Spins</a></li>
                        <li><a href="#">5 Reels</a></li>
                        <li><a href="#">5 Reels</a></li>
                        <li><a href="#">Medium volatility</a></li>
                    </ul>
                </div>
                <div class="game-point">
                    <span class="game-sub">Themes:</span>
                    <ul class="game-tabs">
                        <li><a href="#">Animals</a></li>
                        <li><a href="#">Fishing</a></li>
                        <li><a href="#">Nature</a></li>
                        <li><a href="#">Sea life</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="section-wrap">
    <div class="section-box">
        <!--fishin-->
        <section class="section-one fishin" id="fishin">
            <div class="container">
                <div class="section-top">
                    <h2 class="section-title title-x">Fishin Frenzy Slot Graphics And Sound</h2>
                </div>
                <div class="fishin-content content">
                    <p>The reels are set against a deep blue ocean and symbols are somewhat cartoonish in their rendering. While graphics
                        in this slot are basic, they’re also colourful and give the game a light-hearted, easygoing feel. There’s no
                        background music, but you’ll notice electronic casino-style sound-effects when the reels are spun to generate a
                        little energy as you play.</p>
                </div>
            </div>
        </section>
        <!--/fishin-->
        ...
        <section class="section-one work" id="work">
            <div class="container">
                <div class="section-top">
                    <h2 class="section-title title-x">How The Site Works</h2>
                </div>
                <ol class="work-list">
                    <li>
                        <p class="text-xl">We check all slots before publishing</p>
                    </li>
                    <li>
                        <p class="text-xl">We check the slot developer</p>
                    </li>
                    <li>
                        <p class="text-xl">We search high and low for new Slot games to review and offer in demo mode</p>
                    </li>
                    <li>
                        <p class="text-xl">We advertise third-party Casinos on our free game pages</p>
                    </li>
                    <li>
                        <p class="text-xl">We were recently granted a UKGC licence</p>
                    </li>
                    <li>
                        <p class="text-xl">We are both a licenced operator</p>
                    </li>
                    <li>
                        <p class="text-xl">Enjoy the website 100% for free</p>
                    </li>
                    <li>
                        <p class="text-xl">Casinos we advertise on these free game pages do not necessarily have every game</p>
                    </li>
                </ol>
            </div>
        </section>
        ...
        <section class="section-one our" id="our">
            <div class="container">
                <div class="section-top">
                    <h2 class="section-title title-x">How To Play Slot Demos At Our Free Casino</h2>
                </div>
                <div class="our-content content">
                    <p>Most online slot demos are just free online slots versions of the actual real-money game. You'll be provided with
                        a balance of about 5000 coins or more, and you can play free games to your heart's content.</p>
                    <p class="active">Once you've depleted your play-money balance, then you can refresh the page and play slots free all
                        over again!</p>
                    <p class="active"><em>There are some games, however, that are actual developer demos – such as the free-play slots
                            from
                            Blueprint Gaming. These slot demos let you pick which feature you'd like to try out from a drop-down menu in the
                            top
                            left-hand corner. This way, you can get straight to the point without having to spend too much time waiting for the
                            bonus round to be triggered organically.</em></p>
                    <p class="active"><a href="#">After you've played your chosen game for free here, you can check out real-money sites</a> - <strong>and we recommend those that offer free spins no deposit bonus offers.</strong></p>
                </div>
            </div>
        </section>
        <!--/our-->
        ...
        <section class="section-one faq" id="faq">
            <div class="container">
                <div class="section-top">
                    <h2 class="section-title title-x">FAQ</h2>
                </div>
                <ul class="faq-list">
                    <li class="faq-list_point">
                        <div class="faq-list_top">
                            <h3 class="faq-list_title title-lg">Can I Play Slots Online For Real Money?</h3>
                        ...
                        <div class="faq-list_bottom">
                            <div class="faq-list_text content">
                                <p>Absolutely - if you are over 18 (or of legal gambling age) and in a country that allows online Slots to be
                                    played legally there are 100s of Casinos to choose from with all kinds of different, entertaining games. Of
                                    course, not all casinos are created equal, so be sure to check out a number of reviews of the Casino, from
                                    different sources (not just here) before signing up.</p>
                            </div>
                        </div>
                    </li>
                    <li class="faq-list_point">
...
<path fill-rule="evenodd" clip-rule="evenodd"
      ...
      fill="white" />
        ...
        <ol class="section-content_list">
            <li><a href="#fishin">Fishin Frenzy Slot Graphics And Sound</a></li>
            <li><a href="#work">How The Site Works</a></li>
            <li><a href="#our">How To Play Slot Demos At Our Free Casino</a></li>
